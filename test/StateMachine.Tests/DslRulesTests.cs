...
public class DslRulesTests
{
    ...
    public void Parse_FieldRule_AttachedToField()
    {
        ...
        var balance = machine.DataFields.Single(f => f.Name == "Balance");
    ...
    public void Parse_FieldRule_MultipleRulesOnSameField()
    {
        ...
        var rating = machine.DataFields.Single(f => f.Name == "Rating");
    ...
    public void Parse_StateRule_AttachedToState()
    {
        ...
        machine.StateRules.Should().NotBeNull();
        machine.StateRules!["Paid"].Should().ContainSingle();
        machine.StateRules["Paid"][0].ExpressionText.Should().Be("AmountPaid > 0");
        machine.StateRules["Paid"][0].Reason.Should().Be("Must have paid");
    }
    ...
    public void Parse_StateRule_MultipleStatesWithRules()
    {
        ...
        machine.StateRules.Should().HaveCount(2);
        machine.StateRules!["A"][0].Reason.Should().Be("Non-negative in A");
        machine.StateRules["B"][0].Reason.Should().Be("Must be 10 in B");
    }
    ...
    public void Parse_FieldRule_SourceLineIsCorrect()
    {
        ...
        var rule = machine.DataFields.Single(f => f.Name == "Balance").Rules![0];
    ...
    public void Fire_EventRule_Violated_IsBlocked()
    {
        ...
        result.Outcome.Should().Be(DslOutcomeKind.Blocked);
    ...
    public void Fire_StateRule_NoTransition_IsNotChecked_CorrectDesign()
    {
        ...
        var enterResult = workflow.Fire(
            ...
            "Enter");
        enterResult.IsAccepted.Should().BeTrue();
        ...
        result.IsAccepted.Should().BeTrue();
        result.Outcome.Should().Be(DslOutcomeKind.NoTransition);
    ...
    public void Parse_NoRules_MachineHasNullTopLevelRules()
    {
        ...
        machine.StateRules.Should().BeNull();
        machine.DataFields[0].Rules.Should().BeNull();
    }
