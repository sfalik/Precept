...
- [4. Right-Sizing](#4-right-sizing)
  - [Metrics](#metrics)
  - [The "One Atom" Test](#the-one-atom-test)
  - [Anti-Patterns](#anti-patterns)
- [5. Inputs and Outputs](#5-inputs-and-outputs)
  - [Grammar Generation (Build Time)](#grammar-generation-build-time)
  - [LS Features (Request Time)](#ls-features-request-time)
- [6. Architecture](#6-architecture)
  - [Overall System Architecture](#overall-system-architecture)
  - [VS Code Extension Launch Modes](#vs-code-extension-launch-modes)
  - [Preview Webview Panel](#preview-webview-panel)
- [7. Component Mechanics](#7-component-mechanics)
  - [7.1 TextMate Grammar Generation](#71-textmate-grammar-generation)
  - [7.2 Semantic Token Two-Pass Design](#72-semantic-token-two-pass-design)
  - [7.3 Completion Design](#73-completion-design)
  - [7.4 Hover Design](#74-hover-design)
- [8. Dependencies and Integration Points](#8-dependencies-and-integration-points)
  ...
  - [Extension ↔ Language Server Protocol](#extension-↔-language-server-protocol)
- [9. Failure Modes and Recovery](#9-failure-modes-and-recovery)
  - [Grammar Generation Failures](#grammar-generation-failures)
  - [Semantic Token Failures](#semantic-token-failures)
  - [Completion Failures](#completion-failures)
  - [Hover Failures](#hover-failures)
  - [Extension Launch Failures](#extension-launch-failures)
  - [Preview Panel Failures](#preview-panel-failures)
- [10. Contracts and Guarantees](#10-contracts-and-guarantees)
  - [Grammar Contracts](#grammar-contracts)
  - [Semantic Token Contracts](#semantic-token-contracts)
  - [Completion Contracts](#completion-contracts)
  - [Hover Contracts](#hover-contracts)
  - [Extension Launch Contracts](#extension-launch-contracts)
- [11. Design Rationale and Decisions](#11-design-rationale-and-decisions)
  - [R1: Grammar as Build Output, Not Source](#r1-grammar-as-build-output-not-source)
  - [R2: Two-Pass Semantic Tokens](#r2-two-pass-semantic-tokens)
  - [R3: Catalog-Driven Completions with ValidAfter](#r3-catalog-driven-completions-with-validafter)
  - [R4: Dev-Build Shadow Copy Mode](#r4-dev-build-shadow-copy-mode)
  - [R5: Graceful Degradation Over Hard Failure](#r5-graceful-degradation-over-hard-failure)
- [12. Innovation](#12-innovation)
  - [I1: Grammar Generation from Catalogs](#i1-grammar-generation-from-catalogs)
  - [I2: Single Source for All Editor Surfaces](#i2-single-source-for-all-editor-surfaces)
  - [I3: Zero-Drift Guarantee](#i3-zero-drift-guarantee)
  - [I4: Two-Pass Semantic Tokens with Graceful Degradation](#i4-two-pass-semantic-tokens-with-graceful-degradation)
  - [I5: Live Reload Development Loop](#i5-live-reload-development-loop)
- [13. Open Questions / Implementation Notes](#13-open-questions--implementation-notes)
  - [Implementation State vs. Designed State](#implementation-state-vs-designed-state)
  - [Open Questions](#open-questions)
  - [Implementation Notes](#implementation-notes)
- [14. Deliberate Exclusions](#14-deliberate-exclusions)
  - [E1: No Language Semantics in Editor Code](#e1-no-language-semantics-in-editor-code)
  - [E2: No Hand-Editing of Generated Files](#e2-no-hand-editing-of-generated-files)
  - [E3: No Speculative Semantic Classifications](#e3-no-speculative-semantic-classifications)
  - [E4: No Diagnostic Synthesis in Editor Code](#e4-no-diagnostic-synthesis-in-editor-code)
  - [E5: No Runtime Logic in Preview](#e5-no-runtime-logic-in-preview)
  - [E6: No IDE-Specific Grammar Variants](#e6-no-ide-specific-grammar-variants)
- [15. Cross-References](#15-cross-references)
  - [Related Catalog Files](#related-catalog-files)
  - [Extension Source Files](#extension-source-files)
- [16. Source Files](#16-source-files)
  - [Build-Time Tooling (Grammar Generation)](#build-time-tooling-grammar-generation)
  - [Catalog Metadata (Input to Tooling Surface)](#catalog-metadata-input-to-tooling-surface)
  - [Language Server (Request-Time Tooling)](#language-server-request-time-tooling)
