...
- [Two-Door Literal Model](#two-door-literal-model)
  - [Why two forms](#why-two-forms)
- [Layer 1: Primitive Literals](#layer-1-primitive-literals)
  - [Numeric literals](#numeric-literals)
  - [Boolean literals](#boolean-literals)
  - [No null literal](#no-null-literal)
- [Layer 2: String Literals — `"..."`](#layer-2-string-literals)
  - [Static strings](#static-strings)
  - [Interpolated strings](#interpolated-strings)
  - [Always-on interpolation — no prefix](#always-on-interpolation--no-prefix)
  - [Escape sequences](#escape-sequences)
- [Layer 3: Typed Constants — `'...'`](#layer-3-typed-constants)
  - [Resolution model — context-born, then content-validated](#resolution-model--context-born-then-content-validated)
  - [Content validation table](#content-validation-table)
  - [Context sources](#context-sources)
  - [The parallel with numeric literals](#the-parallel-with-numeric-literals)
  - [Static typed constants](#static-typed-constants)
  - [Interpolated typed constants](#interpolated-typed-constants)
  - [Quantity unit names](#quantity-unit-names)
  - [Integer requirement for temporal quantities](#integer-requirement-for-temporal-quantities)
  - [Combined quantities](#combined-quantities)
- [Layer 4: List Literals — `[...]`](#layer-4-list-literals)
- [Interpolation — Shared Contract](#interpolation--shared-contract)
  - [Expression support](#expression-support)
  - [Nested quoting](#nested-quoting)
- [Pipeline Stage Contracts](#pipeline-stage-contracts)
  - [Lexer](#lexer)
  - [Parser](#parser)
  - [Type Checker](#type-checker)
  - [Evaluator](#evaluator)
  - [Runtime consumer matrix](#runtime-consumer-matrix)
- [String Coercion Table](#string-coercion-table)
- [Future Extensibility](#future-extensibility)
  - [New typed constant inhabitants](#new-typed-constant-inhabitants)
  - [New quantity domains](#new-quantity-domains)
- [Design Rationale and Decisions](#design-rationale-and-decisions)
  - [Two-door model: exactly two quoted forms](#two-door-model-exactly-two-quoted-forms)
  - [Context-born resolution replaces shape-first](#context-born-resolution-replaces-shape-first)
  - [Unit names as validated content, not keywords](#unit-names-as-validated-content-not-keywords)
  - [String coercion is invariant-culture and deterministic](#string-coercion-is-invariant-culture-and-deterministic)
