...
- [6. Architecture](#6-architecture)
  ...
  - [The Tokens Catalog as Source of Truth](#the-tokens-catalog-as-source-of-truth)
  - [Derived Lookup Tables](#derived-lookup-tables)
  - [No Parallel Copies](#no-parallel-copies)
  - [Scanner Structure](#scanner-structure)
- [7. Component Mechanics](#7-component-mechanics)
  - [Main Loop](#main-loop)
  - [Interpolation Mode Stack](#interpolation-mode-stack)
  - [Keyword and Identifier Recognition](#keyword-and-identifier-recognition)
  - [Operator Recognition](#operator-recognition)
  - [Punctuation Recognition](#punctuation-recognition)
  - [String Literal Scanning](#string-literal-scanning)
  - [Typed Constant Scanning](#typed-constant-scanning)
  - [Number Literal Scanning](#number-literal-scanning)
  - [Comment Scanning](#comment-scanning)
  - [Whitespace Handling](#whitespace-handling)
  - [Newline Handling](#newline-handling)
  - [Token.Text for Quoted Literals](#tokentext-for-quoted-literals)
  - [Dual-Use Token Strategy](#dual-use-token-strategy)
  - [What Stays Hand-Written](#what-stays-hand-written)
- [8. Dependencies and Integration Points](#8-dependencies-and-integration-points)
  ...
  - [MCP Language Tool](#mcp-language-tool)
- [9. Failure Modes and Recovery](#9-failure-modes-and-recovery)
  - [Diagnostic Codes](#diagnostic-codes)
  - [Recovery Strategies](#recovery-strategies)
  - [EOF Cleanup](#eof-cleanup)
  - [Diagnostic Audience](#diagnostic-audience)
- [10. Contracts and Guarantees](#10-contracts-and-guarantees)
  - [Token Span Coverage](#token-span-coverage)
  - [Stream Guarantees](#stream-guarantees)
  - [Mode Stack Invariants](#mode-stack-invariants)
  - [Content Buffer Contract](#content-buffer-contract)
- [11. Design Rationale and Decisions](#11-design-rationale-and-decisions)
  - [One-Pass Pure Function](#one-pass-pure-function)
  - [Catalog-Derived Vocabulary](#catalog-derived-vocabulary)
  - [FrozenDictionary + Span Lookup](#frozendictionary--span-lookup)
  - [Fixed-Size Mode Stack](#fixed-size-mode-stack)
  - [64KB Source Limit](#64kb-source-limit)
  - [No Trivia](#no-trivia)
  - [Newline as Token](#newline-as-token)
  - [Dual-Use Tokens (set, min, max)](#dual-use-tokens-set-min-max)
  - [Separate Escape Tables for String vs. Typed Constant](#separate-escape-tables-for-string-vs-typed-constant)
- [12. Innovation](#12-innovation)
  - [Catalog-Driven Token Recognition](#catalog-driven-token-recognition)
  - [Zero-Allocation Keyword Identification](#zero-allocation-keyword-identification)
  - [Metadata-Driven Maximal Munch](#metadata-driven-maximal-munch)
  - [Fixed-Depth Mode Stack](#fixed-depth-mode-stack)
