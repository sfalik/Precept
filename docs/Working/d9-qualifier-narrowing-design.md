...
| **G3** (Site A vs declaration-pure D2) | ✅ **Resolved** — assignment-site consults the ProofEngine discharge result, not a guard-context-threaded `ResolveAssignmentQualifierAxis`; D2 stays declaration-pure. |
