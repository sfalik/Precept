...
> **Archived 2026-05-31** — completed analysis that fed the D9 design (`d9-qualifier-narrowing-design.md`, shipped + promoted to `business-domain-types.md § D9`). Historical reference; do not edit.
