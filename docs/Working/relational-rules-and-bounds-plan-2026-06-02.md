...
- **2c — next** — relational narrowing (D2/D4) + field-ref bounds (5/6/7) + BUG-021 (flag-fold into the set-action path, gated on the narrowing reach for the ~55 samples). The XL centerpiece; Slice 2 plan currently a stub (§ Lightweight phase stub), to be promoted via `/lifecycle-3-plan`.
