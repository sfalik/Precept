...
| **Slice 3b** | Declared-bound obligation ownership — relocate/close the **whole** value-vs-bound family (numeric OutOfRange/NumericOverflow + qualifier residual) | dedicated locked design `phase8-value-level-obligation-ownership-2026-06-01.md` (expands Slice 3 D3, resolves D5) | none (Locked + reviewed) | M–L (~3–4d) | **Next** (design-locked) |
