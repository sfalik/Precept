...
### OF2 — `FunctionArgConstraintViolation` (PRE0022 / `FaultCode` 8): build the capability, or remove the scaffolding? *(Angle 5 F-1)* — has a **new-surface arm**
...
### OF6 — Currency-code case: enforce uppercase-only, or normalize case-insensitively? *(§5 cell-level, business D-BIZ-8)*
