...
- [§1. Grammar Design Philosophy](#1-grammar-design-philosophy)
  - [What Precept's Grammar Is NOT](#what-precepts-grammar-is-not)
  - [The Three Core Design Choices](#the-three-core-design-choices)
  - [The Target Audience Constraint](#the-target-audience-constraint)
- [§2. Grammar Hierarchy](#2-grammar-hierarchy)
  - [What each level owns](#what-each-level-owns)
- [§3. Constructs — The Primary Grammar Unit](#3-constructs--the-primary-grammar-unit)
  - [What a construct is](#what-a-construct-is)
  - [The flat model](#the-flat-model)
  - [Construct anatomy](#construct-anatomy)
- [§4. Construct Families and Disambiguation](#4-construct-families-and-disambiguation)
  - [What a family is](#what-a-family-is)
  - [How disambiguation works](#how-disambiguation-works)
  - [Key families in detail](#key-families-in-detail)
- [§5. Slots — Named Positions Within Constructs](#5-slots--named-positions-within-constructs)
  - [What a slot is](#what-a-slot-is)
  - [Slot kinds](#slot-kinds)
  - [Slot positions in a real construct](#slot-positions-in-a-real-construct)
  - [Named positions vs. positional arguments](#named-positions-vs-positional-arguments)
- [§6. Expressions — Computed Values in Slots](#6-expressions--computed-values-in-slots)
  - [Where expressions appear](#where-expressions-appear)
  - [Expression as a value, not a statement](#expression-as-a-value-not-a-statement)
  - [Expression kinds](#expression-kinds)
  - [Expression structure within a slot](#expression-structure-within-a-slot)
  - [The open design question on expression trees](#the-open-design-question-on-expression-trees)
  - [Why expressions stay inside slots](#why-expressions-stay-inside-slots)
- [§7. The Linguistic Model](#7-the-linguistic-model)
  - [Roles](#roles)
  - [Annotated example](#annotated-example)
  - [Why the linguistic model matters](#why-the-linguistic-model-matters)
- [§8. Grammar Invariants for Language Evolution](#8-grammar-invariants-for-language-evolution)
  - [Invariant 1: Every construct has a unique keyword anchor (or a unique disambiguation path)](#invariant-1-every-construct-has-a-unique-keyword-anchor-or-a-unique-disambiguation-path)
  - [Invariant 2: Family disambiguation must remain linear and guard-bounded](#invariant-2-family-disambiguation-must-remain-linear-and-guard-bounded)
  - [Invariant 3: Slot order is defined by `ConstructMeta` — not inferred from position](#invariant-3-slot-order-is-defined-by-constructmeta--not-inferred-from-position)
  - [Invariant 4: Expressions appear only in expression-typed slots](#invariant-4-expressions-appear-only-in-expression-typed-slots)
...
- [Appendix: Quick Reference](#appendix-quick-reference)
  - [Construct-to-family mapping](#construct-to-family-mapping)
  - [Slot-kind to expression-type mapping](#slot-kind-to-expression-type-mapping)
  - [Grammar invariants at a glance](#grammar-invariants-at-a-glance)
