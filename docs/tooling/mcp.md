...
- [2. Overview](#2-overview)
  - [Discoverable AI-Authoring Tools (catalog projections)](#discoverable-ai-authoring-tools-catalog-projections)
  - [Runtime Tools](#runtime-tools)
  - [Stateless Operation Model](#stateless-operation-model)
...
- [5. Inputs and Outputs](#5-inputs-and-outputs)
  - [Tool Signatures](#tool-signatures)
...
- [7. Component Mechanics](#7-component-mechanics)
  - [`precept_ping`](#precept_ping)
  - [`precept_language` (internal — not registered)](#precept_language-internal-not-registered)
  - [`precept_compile`](#precept_compile)
  - [`precept_inspect`](#precept_inspect)
  - [`precept_fire`](#precept_fire)
  - [`precept_update`](#precept_update)
...
- [9. Failure Modes and Recovery](#9-failure-modes-and-recovery)
  ...
  - [Compilation Error Handling](#compilation-error-handling)
  - [Internal Error Handling](#internal-error-handling)
  - [Recovery Patterns](#recovery-patterns)
- [10. Contracts and Guarantees](#10-contracts-and-guarantees)
  - [Tool Contracts](#tool-contracts)
  - [Outcome Discriminants](#outcome-discriminants)
  - [Vocabulary Guarantee](#vocabulary-guarantee)
  - [JSON Stability](#json-stability)
- [11. Design Rationale and Decisions](#11-design-rationale-and-decisions)
  - [Co-Designed, Not Retrofitted](#co-designed-not-retrofitted)
  - [Thin-Wrapper Discipline](#thin-wrapper-discipline)
  - [Stateless Design](#stateless-design)
  - [Structured Violation Output](#structured-violation-output)
  - [Catalog-Derived Vocabulary](#catalog-derived-vocabulary)
- [12. Innovation](#12-innovation)
  - [Causal Reasoning Surface](#causal-reasoning-surface)
  - [Inspection as First-Class Operation](#inspection-as-first-class-operation)
  - [Complete Language Knowledge via MCP](#complete-language-knowledge-via-mcp)
  - [Fire Pipeline Transparency](#fire-pipeline-transparency)
...
- [14. Deliberate Exclusions](#14-deliberate-exclusions)
  - [No Domain Logic in MCP Layer](#no-domain-logic-in-mcp-layer)
  - [No Custom Serialization](#no-custom-serialization)
