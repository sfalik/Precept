# Precept philosophy — Draft v2

**Status:** Draft. Authored by Frank (Lead Architect). For review by Peterman (brand voice) and Shane (approval).  
**Supersedes:** Current `design/brand/philosophy.md`  
**Grounded in:** `data-vs-state-architecture.md`, `data-vs-state-philosophy.md`, `data-vs-state-runtime.md`, `data-vs-state-pm-research.md`, and directives `copilot-directive-2026-04-08T00-51-03Z.md` and `copilot-directive-2026-04-08T01-30-30Z.md`.  
**Revised:** Incorporates expanded entity scope (Issue #22 / stateless precepts) and updated analog landscape from parallel sample-expansion research thread.
