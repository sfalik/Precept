...
**Requested by:** Shane  
**Date:** 2026-04-05  
**Reference spec:** `design/system/semantic-visual-system.html`  
...
- **Custom palette drift remains unresolved.** The webview still defines off-system colors in `:root` (`--state: #6D7F9B`, `--event: #8573A8`, `--ok: #1FFF7A`, `--err: #FF2A57`, `--muted: #59657A`) instead of the locked preview and inspector guidance in `design/system/semantic-visual-system.html`.
...
- `design/system/semantic-visual-system.html`
