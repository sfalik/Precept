...
public static class Diagnostics
{
    public static DiagnosticMeta GetMeta(DiagnosticCode code) => code switch
    {
        ...
        DiagnosticCode.NonAssociativeComparison         => new(nameof(DiagnosticCode.NonAssociativeComparison),         DiagnosticStage.Parse, Severity.Error,   "Write '{0}' instead — comparison operators like == and < cannot be chained directly"),
        DiagnosticCode.InvalidCallTarget                => new(nameof(DiagnosticCode.InvalidCallTarget),                DiagnosticStage.Parse, Severity.Error,   "Only named functions and methods can be called with parentheses, but found '{0}'"),
        ...
        DiagnosticCode.FunctionArityMismatch          => new(nameof(DiagnosticCode.FunctionArityMismatch),          DiagnosticStage.Type,  Severity.Error,   "'{0}' takes {1} input(s), but {2} were provided"),
