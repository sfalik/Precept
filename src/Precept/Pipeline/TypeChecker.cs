...
/// </summary>
/// <remarks>
/// Implementation is staged across Slices 1–10. Slices 1–5 are live.
...
internal static class TypeChecker
{
    ...
    internal static SemanticIndex Check(ConstructManifest manifest, SymbolTable symbols)
    {
        ...
        // Remaining Pass 2 + final assembly deferred to Slices 6, 8–10.
    ...
    // ════════════════════════════════════════════════════════════════════════
    //  Pass 2 — Transition Row + EventHandler Normalization (Slice 5)
    // ════════════════════════════════════════════════════════════════════════
    ...
    /// <summary>Validate modifier applicability, conflicts, and subsumption for all fields and event args.</summary>
