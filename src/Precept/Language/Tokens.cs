...
public static class Tokens
{
    ...
    public static TokenMeta GetMeta(TokenKind kind) => kind switch
    {
        ...
        TokenKind.Ensure      => new(kind, "ensure",      Cat_Decl, "State/event assertion keyword",
            TextMateScope: "keyword.other.assertion.precept", SemanticTokenType: "keyword"),
        TokenKind.As          => new(kind, "as",          Cat_Decl, "Type annotation",
            TextMateScope: "keyword.other.connective.precept", SemanticTokenType: "keyword", ValidAfter: VA_AfterIdent),
        TokenKind.Default     => new(kind, "default",     Cat_Decl, "Default value modifier",
            TextMateScope: "keyword.other.connective.precept", SemanticTokenType: "keyword", ValidAfter: VA_FieldModifier),
        ...
        TokenKind.Readonly      => new(kind, "readonly",      Cat_Acc, "Access mode adjective: field is read-only in this state",
            TextMateScope: "keyword.other.connective.precept", SemanticTokenType: "keyword", IsAccessModeAdjective: true),
