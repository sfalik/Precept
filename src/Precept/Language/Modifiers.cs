...
public static class Modifiers
{
    ...
    public static ModifierMeta GetMeta(ModifierKind kind) => kind switch
    {
        ...
        // ModifierKind.Writable is retired. The unified `editable` keyword is
        // the AccessModifierMeta `Write` member below, valid at field-
        // declaration AND state-access-row positions.
