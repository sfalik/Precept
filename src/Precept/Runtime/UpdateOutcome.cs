...
public abstract record UpdateOutcome
{
    ...
    public sealed record ConstraintsFailed(IReadOnlyList<ConstraintViolation> Violations) : UpdateOutcome;

    /// <summary>Field is not <c>write</c>-accessible in current state.</summary>
    public sealed record FieldNotEditable(string FieldName, FieldAccessMode ActualMode) : UpdateOutcome;   // TODO D8/R4: field descriptor
