...
2. **Formal spec:** [precept-language-spec.md](precept-language-spec.md) — locked decisions only, grows per compiler stage
3. **Type extensions:** [temporal-type-system.md](temporal-type-system.md) → [business-domain-types.md](business-domain-types.md) (business types depend on temporal)
