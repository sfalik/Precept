...
**Current inhabitants (temporal — first wave):** The seven types listed above. **Future candidates (illustrative, not committed):** UUID, email, URI, semver — each requires formal family-disjointness analysis. See [Literal System](../compiler/literal-system.md) § Forward Design.
