...
> **Grounding:** `docs.next/architecture-planning.md` § 2.1, `docs.next/compiler/pipeline-artifacts-and-consumer-contracts.md` § Pipeline Stages
...
| Topic | Document |
|-------|----------|
| String/typed constant segmentation, escape tables, mode stack modes | [docs.next/compiler/literal-system.md](../compiler/literal-system.md) § Pipeline Stage Contracts → Lexer |
| `TokenStream` shape and consumer contracts | [docs.next/compiler/pipeline-artifacts-and-consumer-contracts.md](../compiler/pipeline-artifacts-and-consumer-contracts.md) § Pipeline Stages |
| Diagnostic codes, messages, and attribution | [docs.next/compiler/diagnostic-system.md](../compiler/diagnostic-system.md) |
| All lexer diagnostic codes | [docs.next/language/precept-language-spec.md](../language/precept-language-spec.md) § 1.8 |
| `set` disambiguation | [docs.next/language/precept-language-spec.md](../language/precept-language-spec.md) § 1.7 |
| Pipeline stage ordering, artifact types | [docs.next/compiler/pipeline-artifacts-and-consumer-contracts.md](../compiler/pipeline-artifacts-and-consumer-contracts.md) |
| Original architecture planning notes | [docs.next/architecture-planning.md](../architecture-planning.md) § 2.1 |
